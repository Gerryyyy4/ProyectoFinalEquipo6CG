...
bool active;
bool actOpDoor = false;
bool actCloseDoor = false;
bool actHumo = true;
bool actHumo2 = false;
...
int main()
{
	...
	Model pay((char*)"Models/Pay/pay.obj");
	Model mesa((char*)"Models/Mesa/mesa.obj");
	Model horno((char*)"Models/Horno/horno.obj");
	Model silla1((char*)"Models/Silla/silla.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::mat4(1);
		model = glm::rotate(model, glm::radians(opDoor), glm::vec3(0.0f, 1.0, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
		...
		model = glm::mat4(1);
		model = glm::translate(glm::mat4(humoMov), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "activaTransparencia"), 0);
